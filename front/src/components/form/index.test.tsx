...
describe("<Form />", () => {
  test("should change input values", () => {
    ...
    const participationFieldNode = getByTestId(
      "ParticipationInput"
    ) as HTMLInputElement;
    ...
    fireEvent.change(lastNameFieldNode, {
      target: { value: fakeObj.lastname },
    });
    fireEvent.change(participationFieldNode, {
      target: { value: fakeObj.participation },
    });
